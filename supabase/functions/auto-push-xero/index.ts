...
//
// This function creates Xero entries FROM SETTLEMENTS ONLY.
            ...
            const pushResponse = await fetch(pushUrl, {
              ...
              body: JSON.stringify({
                ...
                settlementData: {
                  ...
                  sales_principal: s.sales_principal,
                  sales_shipping: s.sales_shipping,
                  refunds: s.refunds,
                  reimbursements: s.reimbursements,
                  seller_fees: s.seller_fees,
                  fba_fees: s.fba_fees,
                  storage_fees: s.storage_fees,
                  advertising_costs: s.advertising_costs,
                  other_fees: s.other_fees,
                  promotional_discounts: s.promotional_discounts,
