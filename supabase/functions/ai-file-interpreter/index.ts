...
serve(async (req) => {
  ...
  try {
    ...
    const { headers: fileHeaders, sampleRows, filename } = await req.json();
            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  is_settlement_file: {
                    type: "boolean",
                    description: "True if this file contains settlement/payout data suitable for accounting. False if it's an orders export, inventory report, or other non-settlement file.",
                  },
                  marketplace_guess: {
                    type: "string",
                    description: "Best guess for which marketplace this file belongs to. Use codes: amazon_au, shopify_payments, bunnings, kogan, bigw, catch, mydeal, woolworths, ebay_au, etsy, theiconic, unknown",
                  },
                  confidence: {
                    type: "number",
                  ...
                  wrong_file_message: {
                    type: "string",
                    description: "If not a settlement file, explain what this file actually is and why it can't be used for accounting",
                  },
                  download_instructions: {
                    type: "string",
                    description: "If wrong file type, provide step-by-step path to download the correct settlement/payout report from the marketplace",
                  },
                },
