...
| auto-generate-shopify-settlements | `supabase/functions/auto-generate-shopify-settlements/` | `settlements` | `upsert` + source preference check + manual overlap guard | ✅ (server-side, source priority enforced) |
