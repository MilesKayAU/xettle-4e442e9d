...
function SettingsView({ xeroConnected, onConnectXero, onGoToUpload }: { xeroConnected: boolean; onConnectXero: () => void; onGoToUpload: () => void }) {
  ...
  const sectionWarningMap: Record<string, string[]> = {
    ...
    account_mapper_tax: ['tax_profile_missing'],
  ...
  const sectionOrder = ['api_connections', 'destination_accounts', 'account_mapper', 'account_mapper_tax', 'posting_mode', 'accounting_boundary', 'payment_verification', 'fulfilment_methods', 'data_quality'] as const;
