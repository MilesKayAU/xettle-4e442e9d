...
export const MARKETPLACE_REGISTRY: Record<string, MarketplaceRegistryEntry> = {
  mydeal: {
    ...
    gst_on_sales: true,
    note_attributes_patterns: ['MyDealOrderID', 'mydeal_order', 'MyDeal Order'],
    tags_patterns: ['mydeal', 'my deal', 'my-deal', 'MyDeal', 'mydeal.com.au'],
    payment_method_patterns: ['mydeal', 'my deal', 'mydeal marketplace', 'mydeal payments'],
    source: 'built_in',
  },
  bunnings: {
    ...
    tags_patterns: ['bunnings', 'mirakl', 'mirakl-connector', 'Bunnings Marketplace', 'bunnings marketplace'],
    payment_method_patterns: ['mirakl', 'bunnings'],
    source: 'built_in',
  },
  jbhifi: {
    display_name: 'JB Hi-Fi',
    contact_name: 'JB Hi-Fi Marketplace',
    payment_type: 'direct_bank_transfer',
    default_sales_account: '200',
    default_shipping_account: '206',
    default_clearing_account: '613',
    default_fees_account: '405',
    gst_on_sales: true,
    note_attributes_patterns: ['JB Hi-Fi', 'jbhifi'],
    tags_patterns: ['jbhifi', 'jb hi-fi', 'jb hifi'],
    source: 'built_in',
  },
  babybunting: {
    display_name: 'Baby Bunting',
    contact_name: 'Baby Bunting Marketplace',
    payment_type: 'direct_bank_transfer',
    default_sales_account: '200',
    default_shipping_account: '206',
    default_clearing_account: '613',
    default_fees_account: '405',
    gst_on_sales: true,
    note_attributes_patterns: ['Baby Bunting', 'babybunting'],
    tags_patterns: ['babybunting', 'baby bunting', 'baby-bunting'],
    source: 'built_in',
  },
  kogan: {
    display_name: 'Kogan',
